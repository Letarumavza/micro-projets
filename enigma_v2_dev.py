...
def enigma(message, r1=0, r2=0, r3=0, F1="ABCDEFGHIJKLMNOPQRSTUVWXYZ", S1="EKMFLGDQVZNTOWYHXUSPAIBRCJ", F2="ABCDEFGHIJKLMNOPQRSTUVWXYZ", S2="AJDKSIRUXBLHWTMCQGZNPYFVOE", F3="ABCDEFGHIJKLMNOPQRSTUVWXYZ", S3="ZYXWVUTSRQPONMLKJIHGFEDCBA", FR="ABCDEFGHIJKLMNOPQRSTUVWXYZ", SR="ZYXWVUTSRQPONMLKJIHGFEDCBA", C1a="A", C1b="X", C2a="Y", C2b="J", C3a="Q", C3b="F"):
    ...
    for a in message:
        ...
        messageout += C1.cable(C2.cable(C3.cable(R1.reverse(R2.reverse(R3.reverse(RF.transcript(R3.transcript(
            R2.transcript(R1.transcript(C3.cable(C2.cable(C1.cable(a))), r1), r2), r3)), -r3), -r2), -r1))))
...
def interface_utilisateur(check=True):
    ...
    while check == True:
        ...
        input()
        print(enigma(message, cr1, cr2, cr3, iR1, sR1, iR2, sR2,
              iR3, sR3, iRF, sRF, c1a, c1b, c2a, c2b, c3a, c3b))
        check = False
...
#       Les filtres et sorties peuvent être modifiés tant qu'ils comportent chacun une seule occurence de chaque lettre.
